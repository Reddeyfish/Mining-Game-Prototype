...
public static class SimplePool {
    ...
    static public GameObject Spawn(GameObject prefab, Vector3 pos)//can't use optional parameters because Vector3.zero and Quat.identity aren't constant at compile time
    {
